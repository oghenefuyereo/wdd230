...
(function() {
    ...
    function displayWeather2(data2) {
        const iconCode2 = data2.weather[0].icon;
        const iconUrl2 = `http://openweathermap.org/img/wn/${iconCode2}@2x.png`;

        const weatherInfo2 = `
            <strong>Weather in ${data2.name}, ${data2.sys.country}</strong><br>
            <img src="${iconUrl2}" alt="Weather icon"><br>
            Condition: ${data2.weather[0].description}, Temperature: ${data2.main.temp}°C<br>
            Wind Speed: ${data2.wind.speed} m/s, Pressure: ${data2.main.pressure} hPa, Humidity: ${data2.main.humidity}%
        `;
...
(function() {
    ...
    function displayWeather2(data2) {
        ...
        const weatherInfo2 = `
            <img src="${iconUrl2}" alt="Weather icon" width="50" height="50">
            <div>
                <strong>Weather in ${data2.name}, ${data2.sys.country}</strong><br>
                Condition: ${data2.weather[0].description}, Temperature: ${data2.main.temp}°C<br>
                Wind Speed: ${data2.wind.speed} m/s, Pressure: ${data2.main.pressure} hPa, Humidity: ${data2.main.humidity}%
        ...
        const weatherContainer2 = document.querySelector('.weather-container');
        weatherContainer2.innerHTML = weatherInfo2;
    }
